...
function calc6() { total = 0; total = 7050 * stringToNum(document.form1.hinmoku6.value) / 1000; document.form1.ans6.value = total; }
function calc7() { total = 0; total = 13637 * stringToNum(document.form1.hinmoku7.value) / 1000; document.form1.ans7.value = total; }
function calc8() { total = 0; total = 108 * stringToNum(document.form1.hinmoku8.value) / 1000; document.form1.ans8.value = total; }
function calc9() { total = 0; total = 62798 * stringToNum(document.form1.hinmoku9.value) / 1000; document.form1.ans9.value = total; }
function calc10() { total = 0; total = 19310 * stringToNum(document.form1.hinmoku10.value) / 1000; document.form1.ans10.value = total; }
function calc11() { total = 0; total = 37353 * stringToNum(document.form1.hinmoku11.value) / 1000; document.form1.ans11.value = total; }
